...
export type SequliaCoverage = "full" | "partial" | "guide" | "none";
...
export interface ScsRequirement {
  ...
  title: string;
  description: string;
  coverage: SequliaCoverage;
  coverageNote: string;
  relatedChecks?: string[];  // Sequlia check names that satisfy this
}

// ★3 requirements (26 items) - Sequliaが対応するもの中心
export const SCS_STAR3_REQUIREMENTS: ScsRequirement[] = [
  // ===== ガバナンスの整備 =====
  {
    ...
    coverage: "guide",
    coverageNote: "Sequliaはポリシーテンプレートと診断根拠資料の生成を支援",
  },
  {
    id: "s3-gov-02",
    star: 3,
    ...
    coverage: "guide",
    coverageNote: "Sequliaのレポートを担当者アサインの根拠資料として活用可能",
  },
  ...
  },
  {
    ...
    coverage: "partial",
    coverageNote: "SequliaはMFA欠落・認証バイパス・JWT脆弱性を検出。実装確認は別途必要",
  ...
  },
  {
    ...
    coverage: "none",
    coverageNote: "エンドポイント管理ツール（EDR等）が必要。Sequliaは対象外",
  },
  {
    id: "s3-prot-07",
    star: 3,
  ...
  // ===== 攻撃等の検知 =====
  {
    ...
    coverage: "guide",
    coverageNote: "Sequliaの診断ログは証跡として利用可能。サーバーログ管理は別途必要",
  },
  {
    id: "s3-det-02",
    star: 3,
    ...
    coverage: "partial",
    coverageNote: "Sequliaはオープンリダイレクト・SSRF・不審なAPIエンドポイントを検出",
  ...
  // ===== インシデントへの対応 =====
  {
    ...
    coverage: "guide",
    coverageNote: "Sequliaの診断レポートは初動対応の根拠資料として活用可能",
  },
  {
    id: "s3-resp-02",
    star: 3,
    ...
    coverage: "none",
    coverageNote: "組織内の体制整備が必要。Sequliaは対象外",
  },
  ...
  // ===== インシデントからの復旧 =====
  {
    ...
    coverage: "none",
    coverageNote: "BCPは組織のプロセス・体制整備が必要。Sequliaは根拠資料として支援",
  },
];
...
export const SCS_STAR4_ADDITIONAL: ScsRequirement[] = [
  {
    ...
    coverage: "guide",
    coverageNote: "Sequliaのリスクスコア・レポートをCISOへの経営報告資料として活用",
  },
  {
    id: "s4-sup-01",
    star: 4,
    ...
    coverage: "full",
    coverageNote: "Sequliaで取引先URLを診断し、SCS準拠状況を可視化。サプライチェーン全体の管理が可能",
  },
  {
    id: "s4-sup-02",
    star: 4,
    ...
    coverage: "guide",
    coverageNote: "Sequliaの診断結果を契約時の証跡・要件確認書類として活用",
  },
  {
    id: "s4-risk-01",
    star: 4,
    ...
    coverage: "full",
    coverageNote: "SequliaはOWASP Top10全カテゴリ・110+チェックを自動実施。診断レポートを第三者評価の根拠として提出可能",
    relatedChecks: ["全チェック"],
  },
  {
    id: "s4-prot-01",
    ...
    coverage: "full",
    coverageNote: "Sequliaは診断履歴・リスクスコアトレンドを蓄積。継続的なセキュリティ改善を支援",
  },
  {
    id: "s4-det-01",
    star: 4,
    ...
    coverage: "partial",
    coverageNote: "Sequliaの診断ログをSIEM連携の基礎データとして活用可能",
  },
];
